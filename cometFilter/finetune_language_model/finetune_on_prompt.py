        ...
        if True:
            ...
            with open(file_path, 'r') as f:
                for row in f:
                    ...
                    # print('orig_sent',  len(orig_sent_copy))
...
def run_finetune_gpt2(gpu_use, pho):
    ...
    parser.add_argument("--train_data_file", default='../data_story/prompt_deal.txt', type=str,
                        required=False,
                        help="The input training data file (a text file).")
    parser.add_argument("--output_dir", default='finetuned_model/roc_char', type=str, required=False,
    ...
    parser.add_argument("--model_name_or_path", default= "finetuned_model/roc_pure", type=str,
