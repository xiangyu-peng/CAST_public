        ...
        if os.path.exists(cached_features_file):
            ...
            with open(file_path, encoding="utf-8") as f:
                ...
                for row in f.readlines():
                    ...
                    orig_sent = orig_sent.replace("{", "")
                    orig_sent = orig_sent.replace("}", ".")
                    # print('orig_sent', orig_sent, len(orig_sent))
                    # orig_sent = orig_sent[1:-1] if orig_sent[0] == '"' else orig_sent
                    ...
                    if len(token_sent) > 3 and len(token_sent) < 1000:
                        num += 1
...
def main():
    ...
    ## Required parameters
    parser.add_argument("--train_data_file", default='../data_story/wiki-scrape/fairytale.csv', type=str, required=False,
                        help="The input training data file (a text file).")
    parser.add_argument("--output_dir", default='finetuned_model/ft_pure', type=str, required=False,
